...
bereitgestellt hat, wurden vom \textit{SmartBillConverter} verarbeitet.
Die generierten XML-Ausgaben wurden von den beiden verwendeten Validatoren akzeptiert.
Damit wurde das definierte Erfolgskriterium erreicht. Die Bandbreite der Testrechnungen ist im Anhang dokumentiert (Tabelle \ref{tab:testrechnungen}).
