...
Anstelle eines Enums wurde ein Union-Type verwendet.\footnote{Vgl. TypeScript Documentation: \textit{Union Types}, \href{https://www.typescriptlang.org/docs/handbook/2/everyday-types.html\#union-types}{typescriptlang.org: Union Types}, abgerufen am 15.01.2025} Das hat folgende Vorteile: Einfacherer Vergleich mit Strings, kleinere Dateigröße und einfachere Umwandlung in JSON.
