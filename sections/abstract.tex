...
All ten test invoices successfully passed the official AUSTRIAPRO ebInterface validator and the German \textit{E-Rechnungs-Validator}, confirming that the defined acceptance criterion was fully met.
...
Alle zehn Testrechnungen haben den offiziellen AUSTRIAPRO-ebInterface-Validator sowie den deutschen \textit{E-Rechnungs-Validator} erfolgreich bestanden und damit das definierte Erfüllungskriterium vollständig erfüllt.
